...
/*
 * La aplicación y la base usan ahora la misma fecha operativa de Salta.
 * El margen de un día que compensaba UTC permitía, innecesariamente, un
 * cierre futuro si alguien escribía directo en la base.
 */
return new class extends Migration
{
    public function up(): void
    {
        DB::unprepared(<<<'SQL'
            ...
            BEGIN
                ...
                IF NEW.period_to > CURRENT_DATE THEN
                    RAISE EXCEPTION
    ...
    {
        /*
         * Es una migración de endurecimiento irreversible: volver a la
         * tolerancia de un día reinstalaría la posibilidad de cierres futuros.
         */
    }
};
