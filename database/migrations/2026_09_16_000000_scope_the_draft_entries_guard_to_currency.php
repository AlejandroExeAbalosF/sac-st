...
/**
 * Un borrador de otra moneda no frena el cierre.
 *
 * Todo lo que mira `period_closings_ready_to_close` estaba acotado a la
 * moneda del cierre --los arqueos, los dias con movimiento, el saldo del
 * libro-- menos el recuento de asientos en borrador, que se quedo mirando
 * caja y fecha. Con la interfaz forzando pesos no se nota; habilitado el
 * dolar, un borrador en una moneda habria impedido cerrar la otra.
 *
 * Es el ultimo resto de la tanda que separo los cierres por moneda.
 */
