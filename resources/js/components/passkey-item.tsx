    ...
    return (
        <div className="flex items-center justify-between border-b p-4 last:border-b-0">
            ...
            <Dialog>
                ...
                <DialogContent>
                    <DialogTitle>Quitar la passkey</DialogTitle>
                    <DialogDescription>
                        ¿Quitar la passkey «{passkey.name}»? Ese equipo deja de
                        servir para entrar. Podés seguir entrando con tu
                        contraseña.
                    </DialogDescription>
                    <DialogFooter className="gap-2">
                        ...
                        <Button
                            ...
                            disabled={isDeleting}
                        >
                            {isDeleting ? 'Quitando…' : 'Quitar la passkey'}
                        </Button>
                    </DialogFooter>
                </DialogContent>
            </Dialog>
